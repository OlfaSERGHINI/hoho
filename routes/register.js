...
router.post('/', async (req, res, next) => {
  ...
  let email=req.body.email_phone_login;
  let zipCode;
  let suscription=req.body.num_abo;
  let appLocation=req.body.appLocation;
  ...
  if(filtered){
    ...
    if(appLocation=='fr'|| appLocation=='fr'){
       zipCode=req.body.cp;
    }
    try {
      await client.createUser({
        profile: {
          ...
          resubscription_number:suscription,
